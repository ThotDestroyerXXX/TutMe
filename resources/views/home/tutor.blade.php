...
<div class="homepage">
    <div class="content">
        <div class="title">
            <h3>Hi, {{ optional(Auth::user())->name }}!</h3>
        ...
        <div class="enrollmentHistory" style="margin-top: 3rem;">
            ...
            <div class="courseList">
                @if (!$coursesById)
                <p style="text-align:center;">Enrollment belum tersedia.</p>
                @endif
                <div class="cardList">
        ...
        <div style="display: flex; margin-top: 5rem;">
            ...
            <div style="margin-left: auto;">
                <a href="{{ route('course') }}" class="btn btn-primary bg-white border border-primary rounded-3 ms-2 text-decoration: none;" style="color: #363636ff;">
                    New Course
                </a>
            </div>
        </div>
        <div class="courseList">
            ...
            <div style="display: flex; gap: 20px; overflow-x: auto; padding: 20px;">
                ...
                <a href="{{ route('course', ['id' => $course->id]) }}" style="text-decoration: none; color: inherit;">
                    <div class="course-card" data-level="{{ $course->level }}"
