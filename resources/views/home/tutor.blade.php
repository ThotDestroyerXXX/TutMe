...
@section('content')
    ...
    <div class="homepage">
        <div class="content">
            <div class="title">
                <h3>{{ __('messages.hi') }}, {{ optional(Auth::user())->name }}!</h3>
                <h6>{{ __('messages.what_to_teach_today') }}</h6>
            </div>
            <div class="enrollmentHistory" style="margin-top: 3rem;">
                <div class="historyTitle" style="display: flex;">
                    <h6>{{ __('messages.enrollment') }}</h6>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="courseList">
                    @if (!$coursesById)
                        <p style="text-align:center;">{{ __('messages.no_enrollments_available') }}</p>
                    @endif
                    <div class="cardList">
                            ...
                            <div class="course-card" data-level="{{ $course->level }}"
                                ...
                                <div style="position: relative; border-radius: 10px; overflow: hidden;">
                                    ...
                                    <div
                                        ...
                                        {{ $course->session }} {{ __('messages.session') }} | {{ $course->session * 60 }}
                                        {{ __('messages.minutes') }}
                                    </div>
                                </div>
                                ...
                                @if ($course->is_active) background-color: #00ff6aff; @endif
                                ">
                                    </div>
