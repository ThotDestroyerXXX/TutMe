    ...
    <div class="content">
        ...
        <div style="display: flex; margin-top: 5rem;">
            ...
            <div style="margin-left: auto;">
                <form action="{{ route('course.create') }}" method="GET">
                    <button type="submit" class="btn btn-primary bg-white border border-primary rounded-3 ms-2"
                        style="color: #363636ff;">New Course</button>
                </form>
            </div>
        </div>
        <div class="courseList">
            ...
            <div style="display: flex; gap: 20px; overflow-x: auto; padding: 20px;">
                ...
                <a href="{{ route('course.create', ['id' => $course->id]) }}" style="text-decoration: none; color: inherit;">
